...
plot_psO_jki_seq2_seq4_Go_2020_filt_rarefied_shannon_rotation <- ggboxplot(psO_jki_seq2_seq4_Go_2020_filt_rarefied.meta, "Rotation", "shannon", fill = "Rotation", color = "Rotation", palette = c("#e7e5cc", "#9cc184", "#1e3d14"), ylab = "Shannon index") +
  ...
  scale_y_continuous(limits = c(5.0, 8.0), breaks = seq(5, 8, by = 1.0), label = c("5.0", "6.0", "7.0", "8.0")) +
  ...
  stat_compare_means(comparisons = alfa_div_comparison_rotation_Go, symnum.args = list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, 1), symbols = c("****", "***", "**", "*", "ns")), bracket.size = .3, size=3, label.y = c(7.0, 7.2, 7.4))
plot_psO_jki_seq2_seq4_Go_2020_filt_rarefied_shannon_rotation

ggsave("plot_psO_jki_seq2_seq4_Go_2020_filt_rarefied_shannon_rotation.png", path = "~/Documents/R_analysis/jki_seq2_seq4/output_jki_seq2_seq4/Alpha_div_jki_seq2_seq4/", width = 18, height = 12, units = "cm",dpi = 300)
...
ggsave("plot_psO_jki_seq2_seq4_Go_2021_filt_rarefied_shannon_rotation.png", path = "~/Documents/R_analysis/jki_seq2_seq4/output_jki_seq2_seq4/Alpha_div_jki_seq2_seq4/", width = 18, height = 12, units = "cm",dpi = 300)
...
plot_psO_jki_seq2_seq4_Ki_2020_filt_rarefied_shannon_rotation <- ggboxplot(psO_jki_seq2_seq4_Ki_2020_filt_rarefied.meta, "Rotation", "shannon", fill = "Rotation", color = "Rotation", palette = c("#e7e5cc", "#9cc184", "#1e3d14"), ylab = "Shannon index") +
  ...
  theme(legend.title = element_text(size=30), legend.text = element_text(size = 30, colour = "black")) +
  stat_compare_means(method = "kruskal", label= "p", label.y = 7.7, label.x = 1, size=5) +
  stat_compare_means(comparisons = alfa_div_comparison_rotation_Ki, symnum.args = list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, 1), symbols = c("****", "***", "**", "*", "ns")), bracket.size = .3, size=3, label.y = c(7.0))
plot_psO_jki_seq2_seq4_Ki_2020_filt_rarefied_shannon_rotation

ggsave("plot_psO_jki_seq2_seq4_Ki_2020_filt_rarefied_shannon_rotation.png", path = "~/Documents/R_analysis/jki_seq2_seq4/output_jki_seq2_seq4/Alpha_div_jki_seq2_seq4/", width = 18, height = 12, units = "cm",dpi = 300)
...
plot_psO_jki_seq2_seq4_Ki_2021_filt_rarefied_shannon_rotation <- ggboxplot(psO_jki_seq2_seq4_Ki_2021_filt_rarefied.meta, "Rotation", "shannon", fill = "Rotation", color = "Rotation", palette = c("#e7e5cc", "#9cc184", "#1e3d14"), ylab = "Shannon index") +
  theme_bw() +  geom_boxplot(alpha = 0.2) +
  facet_grid(~Microhabitat, scales = "free") +
  scale_y_continuous(limits = c(3.5, 7.5), breaks = seq(3.5, 7.5, by = 1.0), label = c("3.5", "4.5", "5.5", "6.5", "7.5")) +
  theme(legend.position = 'none') +
  theme(axis.title.x = element_blank(), axis.title.y = element_text(size = 30, colour = "black")) +
  theme(axis.text.x = element_text(size=30, angle = 90,vjust =0.5, hjust = 1 ), axis.text.y = element_text(size=30)) +
  theme(strip.text.x = element_text(size = 30), strip.text.y = element_text(size = 30)) +
  theme(legend.title = element_text(size=30), legend.text = element_text(size = 30, colour = "black")) +
  stat_compare_means(method = "kruskal", label= "p", label.y = 7.2, label.x = 1, size=5) +
  stat_compare_means(comparisons = alfa_div_comparison_rotation_Ki, symnum.args = list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, 1), symbols = c("****", "***", "**", "*", "ns")), bracket.size = .3, size=3, label.y = c(6.8))
plot_psO_jki_seq2_seq4_Ki_2021_filt_rarefied_shannon_rotation

ggsave("plot_psO_jki_seq2_seq4_Ki_2021_filt_rarefied_shannon_rotation.png", path = "~/Documents/R_analysis/jki_seq2_seq4/output_jki_seq2_seq4/Alpha_div_jki_seq2_seq4/", width = 18, height = 12, units = "cm",dpi = 300)
...
plot_psO_jki_seq2_seq4_Go_2020_filt_rarefied_chao1_rotation <- ggboxplot(psO_jki_seq2_seq4_Go_2020_filt_rarefied.meta, "Rotation", "chao1", fill = "Rotation", color = "Rotation", palette = c("#e7e5cc", "#9cc184", "#1e3d14"), ylab = "Chao1 index") +
  ...
  stat_compare_means(comparisons = alfa_div_comparison_rotation_Go, symnum.args = list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, 1), symbols = c("****", "***", "**", "*", "ns")), bracket.size = .3, size=3, label.y = c(1850, 1950, 2050))

plot_psO_jki_seq2_seq4_Go_2020_filt_rarefied_chao1_rotation

ggsave("plot_psO_jki_seq2_seq4_Go_2020_filt_rarefied_chao1_rotation.png", path = "~/Documents/R_analysis/jki_seq2_seq4/output_jki_seq2_seq4/Alpha_div_jki_seq2_seq4/", width = 18, height = 12, units = "cm",dpi = 300)
...
ggsave("plot_psO_jki_seq2_seq4_Go_2021_filt_rarefied_chao1_rotation.png", path = "~/Documents/R_analysis/jki_seq2_seq4/output_jki_seq2_seq4/Alpha_div_jki_seq2_seq4/", width = 18, height = 12, units = "cm",dpi = 300)



#to compare rotations in Ki
plot_psO_jki_seq2_seq4_Ki_2020_filt_rarefied_chao1_rotation <- ggboxplot(psO_jki_seq2_seq4_Ki_2020_filt_rarefied.meta, "Rotation", "chao1", fill = "Rotation", color = "Rotation", palette = c("#e7e5cc", "#9cc184", "#1e3d14"), ylab = "Chao1 index") +
  theme_bw() +  geom_boxplot(alpha = 0.2) +
  facet_grid(~Microhabitat, scales = "free") +
  scale_y_continuous(limits = c(600, 2100), breaks = seq(600, 2100, by = 300), label = c("600", "900", "1200", "1500", "1800", "2100")) +
  theme(legend.position = 'none') +
  ...
  theme(legend.title = element_text(size=30), legend.text = element_text(size = 30, colour = "black")) +
  stat_compare_means(method = "kruskal", label= "p", label.y = 1950, label.x = 1, size=5) +
  stat_compare_means(comparisons = alfa_div_comparison_rotation_Ki, symnum.args = list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, 1), symbols = c("****", "***", "**", "*", "ns")), bracket.size = .3, size=3, label.y = c(1850, 1950, 2050))

plot_psO_jki_seq2_seq4_Ki_2020_filt_rarefied_chao1_rotation

ggsave("plot_psO_jki_seq2_seq4_Ki_2020_filt_rarefied_chao1_rotation.png", path = "~/Documents/R_analysis/jki_seq2_seq4/output_jki_seq2_seq4/Alpha_div_jki_seq2_seq4/", width = 18, height = 12, units = "cm",dpi = 300)

plot_psO_jki_seq2_seq4_Ki_2021_filt_rarefied_chao1_rotation <- ggboxplot(psO_jki_seq2_seq4_Ki_2021_filt_rarefied.meta, "Rotation", "chao1", fill = "Rotation", color = "Rotation", palette = c("#e7e5cc", "#9cc184", "#1e3d14"), ylab = "Chao1 index") +
  theme_bw() +  geom_boxplot(alpha = 0.2) +
  facet_grid(~Microhabitat, scales = "free") +
  scale_y_continuous(limits = c(600, 2100), breaks = seq(600, 2100, by = 300), label = c("600", "900", "1200", "1500", "1800", "2100")) +
  theme(legend.position = 'none') +
...
ggsave("plot_psO_jki_seq2_seq4_Ki_2021_filt_rarefied_chao1_rotation.png", path = "~/Documents/R_analysis/jki_seq2_seq4/output_jki_seq2_seq4/Alpha_div_jki_seq2_seq4/", width = 18, height = 12, units = "cm",dpi = 300)
...
plot_psO_jki_seq2_seq4_Go_2020_filt_rarefied_pielou_rotation <- ggboxplot(psO_jki_seq2_seq4_Go_2020_filt_rarefied.meta, "Rotation", "pielou", fill = "Rotation", color = "Rotation", palette = c("#e7e5cc", "#9cc184", "#1e3d14"), ylab = "Pielou index") +
  theme_bw() +  geom_boxplot(alpha = 0.2) +
  facet_grid(~Microhabitat, scales = "free") +
  scale_y_continuous(limits = c(0.70, 1.0), breaks = seq(0.70, 1.0, by = 0.1), label = c("0.70", "0.80", "0.90", "1.0")) +
  theme(legend.position = 'none') +
  theme(axis.title.x = element_blank(), axis.title.y = element_text(size = 30, colour = "black")) +
  theme(axis.text.x = element_text(size=30, angle = 90,vjust =0.5, hjust = 1 ), axis.text.y = element_text(size=30)) +
  theme(strip.text.x = element_text(size = 30), strip.text.y = element_text(size = 30)) +
  ...
  stat_compare_means(comparisons = alfa_div_comparison_rotation_Go, symnum.args = list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, 1), symbols = c("****", "***", "**", "*", "ns")), bracket.size = .3, size=3, label.y = c(0.91, 0.93, 0.95))
plot_psO_jki_seq2_seq4_Go_2020_filt_rarefied_pielou_rotation

ggsave("plot_psO_jki_seq2_seq4_Go_2020_filt_rarefied_pielou_rotation.png", path = "~/Documents/R_analysis/jki_seq2_seq4/output_jki_seq2_seq4/Alpha_div_jki_seq2_seq4/", width = 18, height = 12, units = "cm",dpi = 300)
...
ggsave("plot_psO_jki_seq2_seq4_Go_2021_filt_rarefied_pielou_rotation.png", path = "~/Documents/R_analysis/jki_seq2_seq4/output_jki_seq2_seq4/Alpha_div_jki_seq2_seq4/", width = 18, height = 12, units = "cm",dpi = 300)


#to compare rotations in Ki
plot_psO_jki_seq2_seq4_Ki_2020_filt_rarefied_pielou_rotation <- ggboxplot(psO_jki_seq2_seq4_Ki_2020_filt_rarefied.meta, "Rotation", "pielou", fill = "Rotation", color = "Rotation", palette = c("#e7e5cc", "#9cc184", "#1e3d14"), ylab = "Pielou index") +
  theme_bw() +  geom_boxplot(alpha = 0.2) +
  facet_grid(~Microhabitat, scales = "free") +
  scale_y_continuous(limits = c(0.70, 1.0), breaks = seq(0.70, 1.0, by = 0.1), label = c("0.70", "0.80", "0.90", "1.0")) +
  theme(legend.position = 'none') +
...
ggsave("plot_psO_jki_seq2_seq4_Ki_2020_filt_rarefied_pielou_rotation.png", path = "~/Documents/R_analysis/jki_seq2_seq4/output_jki_seq2_seq4/Alpha_div_jki_seq2_seq4/", width = 18, height = 12, units = "cm",dpi = 300)


plot_psO_jki_seq2_seq4_Ki_2021_filt_rarefied_pielou_rotation <- ggboxplot(psO_jki_seq2_seq4_Ki_2021_filt_rarefied.meta, "Rotation", "pielou", fill = "Rotation", color = "Rotation", palette = c("#e7e5cc", "#9cc184", "#1e3d14"), ylab = "Pielou index") +
  theme_bw() +  geom_boxplot(alpha = 0.2) +
  facet_grid(~Microhabitat, scales = "free") +
...
ggsave("plot_psO_jki_seq2_seq4_Ki_2021_filt_rarefied_pielou_rotation.png", path = "~/Documents/R_analysis/jki_seq2_seq4/output_jki_seq2_seq4/Alpha_div_jki_seq2_seq4/", width = 18, height = 12, units = "cm",dpi = 300)
