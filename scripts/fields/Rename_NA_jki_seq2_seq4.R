...
#Export tax table
tax <- data.frame(tax_table(jki_seq2_seq4_data))
...
tax_table(jki_seq2_seq4_data) <- as.matrix(tax.clean)
head(tax_table(jki_seq2_seq4_data))
tail(tax_table(jki_seq2_seq4_data))
