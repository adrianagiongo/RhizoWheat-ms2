...
hist(log10(taxa_sums(psO_jki_seq2_seq4)))
...
psO_jki_seq2_seq4_aggreg_rare_phy <- aggregate_rare_taxa(psO_jki_seq2_seq4, level="Phylum", detection = 1000, prevalence =20/total_samples_psO_jki_seq2_seq4)
...
#######
plot_bar_average_psO_jki_seq2_seq4_aggreg_rare_phy_rel <- plot_composition(psO_jki_seq2_seq4_aggreg_rare_phy_rel, otu.sort = "abundance", sample.sort = "Firmicutes", x.label = "Site", plot.type = "barplot", average_by = "Site", verbose = FALSE) +
  theme_bw() +
...
plot_bar_average_psO_jki_seq2_seq4_aggreg_rare_phy_rel

ggsave("plot_bar_average_psO_jki_seq2_seq4_aggreg_rare_phy_rel.png", path = "~/Documents/R_analysis/jki_seq2_seq4/output_jki_seq2_seq4/Compositional_barplot_jki_seq2_seq4/", width = 16, height = 15, units = "cm",dpi = 300, device = "png")
