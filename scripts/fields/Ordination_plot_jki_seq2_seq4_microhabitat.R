...
### Different locations
MDS_bray_psO_jki_seq2_seq4_Go_2020_filt_sqr<-ordinate(psO_jki_seq2_seq4_Go_2020_filt, "MDS","bray", autotransform=TRUE)
...
#Create a MDS plot 
#### ASVs  Go
plot_MDS_bray_psO_jki_seq2_seq4_Go_2020_filt_sqr_microhabitat<-plot_ordination(psO_jki_seq2_seq4_Go_2020_filt, MDS_bray_psO_jki_seq2_seq4_Go_2020_filt_sqr, type="sample", color="Microhabitat", shape="Rotation") + 
  geom_point(size=4) +
  theme_bw() +
...
plot_MDS_bray_psO_jki_seq2_seq4_Go_2020_filt_sqr_microhabitat

ggsave("plot_MDS_bray_psO_jki_seq2_seq4_Go_2020_filt_sqr_microhabitat.tiff", path = "~/Documents/R_analysis/jki_seq2_seq4/output_jki_seq2_seq4/Ordination_jki_seq2_seq4/", width = 15, height = 10, units = "cm", dpi = 300, device = "tiff")



plot_MDS_bray_psO_jki_seq2_seq4_Go_2021_filt_sqr_microhabitat<-plot_ordination(psO_jki_seq2_seq4_Go_2021_filt, MDS_bray_psO_jki_seq2_seq4_Go_2021_filt_sqr, type="sample",color="Microhabitat", shape="Rotation") + 
  geom_point(size=4) +
  theme_bw() +
  theme(axis.text = element_text(size=18)) +
  theme(axis.title = element_text(size=20)) +
  ...
  scale_shape_manual(values=c(16, 17, 15))+
  scale_color_manual(values = c("#b05644", "#d9b967", "#57896a"))
plot_MDS_bray_psO_jki_seq2_seq4_Go_2021_filt_sqr_microhabitat

ggsave("plot_MDS_bray_psO_jki_seq2_seq4_Go_2021_filt_sqr_microhabitat.tiff", path = "~/Documents/R_analysis/jki_seq2_seq4/output_jki_seq2_seq4/Ordination_jki_seq2_seq4/", width = 15, height = 10, units = "cm", dpi = 300, device = "tiff")

#### ASVs  Ki
plot_MDS_bray_psO_jki_seq2_seq4_Ki_2020_filt_sqr_microhabitat<-plot_ordination(psO_jki_seq2_seq4_Ki_2020_filt, MDS_bray_psO_jki_seq2_seq4_Ki_2020_filt_sqr, type="sample",color="Microhabitat", shape="Rotation") + 
  geom_point(size=4) +
  theme_bw() +
  theme(axis.text = element_text(size=18)) +
  theme(axis.title = element_text(size=20)) +
  ...
  scale_color_manual(values = c("#b05644", "#d9b967", "#57896a"))
plot_MDS_bray_psO_jki_seq2_seq4_Ki_2020_filt_sqr_microhabitat

ggsave("plot_MDS_bray_psO_jki_seq2_seq4_Ki_2020_filt_sqr_microhabitat.tiff", path = "~/Documents/R_analysis/jki_seq2_seq4/output_jki_seq2_seq4/Ordination_jki_seq2_seq4/", width = 15, height = 10, units = "cm", dpi = 300, device = "tiff")

plot_MDS_bray_psO_jki_seq2_seq4_Ki_2021_filt_sqr_microhabitat<-plot_ordination(psO_jki_seq2_seq4_Ki_2021_filt, MDS_bray_psO_jki_seq2_seq4_Ki_2021_filt_sqr, type="sample",color="Microhabitat", shape="Rotation") + 
  geom_point(size=4) +
  theme_bw() +
  theme(axis.text = element_text(size=18)) +
  theme(axis.title = element_text(size=20)) +
  ...
  scale_shape_manual(values=c(16, 18))+
  scale_color_manual(values = c("#b05644", "#d9b967", "#57896a"))
plot_MDS_bray_psO_jki_seq2_seq4_Ki_2021_filt_sqr_microhabitat

ggsave("plot_MDS_bray_psO_jki_seq2_seq4_Ki_2021_filt_sqr_microhabitat.tiff", path = "~/Documents/R_analysis/jki_seq2_seq4/output_jki_seq2_seq4/Ordination_jki_seq2_seq4/", width = 15, height = 10, units = "cm", dpi = 300, device = "tiff")
