...
otu_mat<-read_excel("~/Documents/R_analysis/jki_seq10/data_jki_seq10/jki_seq10_otu.xlsx")
taxo_mat<-read_excel("~/Documents/R_analysis/jki_seq10/data_jki_seq10/jki_seq10_taxa.xlsx")
metadata<-read.csv("~/Documents/R_analysis/jki_seq10/data_jki_seq10/jki_seq10_metadata.csv", row.names = 1)
...
jki_seq10_data<-phyloseq(OTU, TAX, SAMPLE)
...
sample_variables(jki_seq10_data)
